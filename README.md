# 简介
这个项目是一个简单的教务查询系统，基于 https://github.com/JaceyRx/Examination_System 项目的二次开发
...
* 运行
![image](https://github.com/HeatDeath/examination_system/blob/master/picture/20171130082955.png)
* 登录账户
  * 管理员账户：admin
  * 老师账户：1001
  * 学生账户：10001
